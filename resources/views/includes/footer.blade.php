...
<footer class="footer bg-gray">
    <div class="container">
        ...
        <!-- Copyright -->
        <div class="copyright bg-gray small d-flex">
            <div>&copy; Copyright {{ date('Y') }} <strong><span>ADHDCheck</span></strong>. All Rights Reserved.
            </div>
            <div class="ms-auto">Developed by&nbsp;Azis Rahman Prasetio</div>
        </div>
    </div>
</footer>
